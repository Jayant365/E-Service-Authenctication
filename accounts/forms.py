...
class RegisterForm(forms.ModelForm):
    ...
    fields, plus a repeated password."""
    email = forms.EmailField(label='',widget=forms.EmailInput(attrs={'placeholder':'Email.'}))
    full_name = forms.CharField(label='',widget=forms.TextInput(attrs={'placeholder':'Your Name.'}))
    phone_no = forms.IntegerField(label='',widget=forms.TextInput(attrs={'placeholder':'Phone.'}))
